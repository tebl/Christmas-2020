...
U 1 1 5F88FAC0
P 5850 3300
F 0 "A1" H 5525 4250 50  0000 C CNN
F 1 "Arduino_Nano" V 5850 3300 50  0000 C CNN
F 2 "christmas:Arduino_Nano" H 6000 2350 50  0001 L CNN
F 3 "http://www.mouser.com/pdfdocs/Gravitech_Arduino_Nano3_0.pdf" H 5850 2300 50  0001 C CNN
	1    5850 3300
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F8902B7
P 3675 2950
F 0 "U1" H 4025 3550 50  0000 C CNN
F 1 "74HC595_L" V 3675 2950 50  0000 C CNN
F 2 "Housings_DIP:DIP-16_W7.62mm_LongPads" H 3675 2950 50  0001 C CNN
F 3 "74xx/74HC595.pdf" H 3675 2950 50  0001 C CNN
	1    3675 2950
	-1   0    0    -1  
$EndComp
$Comp
...
U 1 1 5F89350E
P 3625 3750
F 0 "#PWR0101" H 3625 3500 50  0001 C CNN
F 1 "GND" H 3630 3577 50  0000 C CNN
F 2 "" H 3625 3750 50  0001 C CNN
...
U 1 1 5F898B23
P 3625 6125
F 0 "#PWR0102" H 3625 5875 50  0001 C CNN
F 1 "GND" H 3630 5952 50  0000 C CNN
...
U 1 1 5F899E23
P 3625 2150
F 0 "#PWR0103" H 3625 2000 50  0001 C CNN
F 1 "+5V" H 3640 2323 50  0000 C CNN
...
U 1 1 5F89B934
P 3625 4525
F 0 "#PWR0104" H 3625 4375 50  0001 C CNN
F 1 "+5V" H 3640 4698 50  0000 C CNN
...
Wire Wire Line
	4600 2700 4375 2700
Text Label 5325 3100 2    50   ~ 0
SH_CLOCK
Text Label 5325 3500 2    50   ~ 0
SH_DATA
Wire Wire Line
	4375 2500 4675 2500
Text Label 5325 2900 2    50   ~ 0
SH_LATCH
Wire Wire Line
	4525 2600 4525 3100
Wire Wire Line
...
U 1 1 5F8B34E1
P 5950 4450
F 0 "#PWR0105" H 5950 4200 50  0001 C CNN
...
U 1 1 5F8B407F
P 6050 2225
F 0 "#PWR0106" H 6050 2075 50  0001 C CNN
F 1 "+5V" H 6065 2398 50  0000 C CNN
...
U 1 1 5F8B6195
P 5000 4100
F 0 "SW1" V 5046 4052 50  0000 R CNN
F 1 "SELECT" V 4955 4052 50  0000 R CNN
F 2 "Buttons_Switches_THT:SW_PUSH_6mm" H 5000 4300 50  0001 C CNN
...
U 1 1 5F8DC985
P 7150 2225
F 0 "#PWR0107" H 7150 2075 50  0001 C CNN
F 1 "+5V" H 7165 2398 50  0000 C CNN
...
U 1 1 5F898B1D
P 3675 5325
F 0 "U2" H 4025 5925 50  0000 C CNN
F 1 "74HC595_R" V 3675 5325 50  0000 C CNN
F 2 "Housings_DIP:DIP-16_W7.62mm_LongPads" H 3675 5325 50  0001 C CNN
F 3 "74xx/74HC595.pdf" H 3675 5325 50  0001 C CNN
	1    3675 5325
	-1   0    0    -1  
$EndComp
NoConn ~ 2450 2900
